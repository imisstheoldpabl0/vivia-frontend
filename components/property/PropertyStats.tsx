...
export function PropertyStats({ property }: PropertyStatsProps) {
  const stats = [
    ...
    {
      label: 'Habitaciones',
      value: getBedroomLabel(property.bedrooms),
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    {
      label: 'Baños',
      value: getBathroomLabel(property.bathrooms),
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
  ...
  if (property.floor !== undefined) {
    stats.push({
      label: 'Planta',
      value: getFloorLabel(property.floor),
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
      ...
      {stats.map((stat) => (
        ...
        >
          ...
          <div>
            ...
            <div className="font-medium text-text">{stat.value}</div>
          </div>
        </div>
      ))}
    </div>
